...
variable "apigee_instances_metadata" {
  description = "Metadata for Apigee Instances (only one instance for EVAL orgs) along with L7 ILB configuration."
  type = map(object({
    ...
    # l7_ilb_subnet_name             = string
    # l7_ilb_subnet_cidr_range       = string
